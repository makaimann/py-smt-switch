...
class CVC4Solver(SolverBase):
    ...
    def __init__(self, lang='auto'):
        ...
        self._CVC4Funs = {functions.extract: CVC4.BitVectorExtract,
                          ...
                          functions.bvashr: CVC4.BITVECTOR_ASHR,
                          functions.bvlshr: CVC4.BITVECTOR_LSHR,
                          functions.bvult: CVC4.BITVECTOR_ULT,
                          functions.bvule: CVC4.BITVECTOR_ULE,
                          functions.bvugt: CVC4.BITVECTOR_UGT,
                          functions.bvuge: CVC4.BITVECTOR_UGE,
